...
export default function TeacherNoticesPage() {
  ...
  useEffect(() => {
    // Mock fetch notices targeting teachers
    setTimeout(() => {
      setNotices([
        { id: '1', title: 'Quarterly Staff Meeting', content: 'Academic session syllabus planning and register audits will be reviewed this Saturday in the conference hall.', target: 'Teachers', date: '2026-07-02' },
        { id: '2', title: 'Summer Vacation Circular 2026', content: 'The school will remain closed from May 15th to June 25th for summer vacations. Online assignments will be published on the portal.', target: 'All', date: '2026-05-01' },
      ]);
      setLoading(false);
    }, 300);
  }, []);
